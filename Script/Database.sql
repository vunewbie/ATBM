...
-- SYSTEM PRIVILEGES
GRANT CREATE TABLE, CREATE USER, CREATE ROLE, CREATE TRIGGER, CREATE VIEW, CREATE SESSION, CREATE ANY SEQUENCE, CREATE ANY PROCEDURE TO "C##QLTDH" ;
GRANT ALTER USER, ALTER ANY ROLE, ALTER ANY TRIGGER, ALTER SESSION, ALTER ANY SEQUENCE TO "C##QLTDH" ;
GRANT DROP USER, DROP ANY ROLE, DROP ANY TRIGGER, DROP ANY VIEW, DROP ANY SEQUENCE, DROP ANY PROCEDURE TO "C##QLTDH" ;
GRANT SELECT ANY DICTIONARY TO "C##QLTDH" ;
GRANT UNLIMITED TABLESPACE TO "C##QLTDH" ;
GRANT GRANT ANY OBJECT PRIVILEGE, GRANT ANY PRIVILEGE TO "C##QLTDH" ;
GRANT EXECUTE ANY PROCEDURE TO "C##QLTDH" ;
