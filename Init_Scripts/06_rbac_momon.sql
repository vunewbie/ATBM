...
BEGIN   
    ...
    VALUES (p_mamm, p_mahp, p_magv, p_hk, p_nam);
...
BEGIN
    QLTDH.EDUCATION_DEPARTMENT_INSERT_COURSE_OFFERING('TEST', 'CNT0001', 'GV0002', '2', 2025);
END;
/

-- Ví dụ cập nhật môn học
BEGIN
    QLTDH.EDUCATION_DEPARTMENT_UPDATE_COURSE_OFFERING('TEST', 'CNT0003', 'GV0001', '2', 2025);
END;
/

SELECT * FROM QLTDH.EDUCATION_DEPARTMENT_GET_COURSE_OFFERING WHERE MAMM = 'TEST';

-- Ví dụ xóa môn học
BEGIN
    QLTDH.EDUCATION_DEPARTMENT_DELETE_COURSE_OFFERING('TEST');
END;
/
