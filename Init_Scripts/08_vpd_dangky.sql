...
UPDATE QLTDH.MOMON 
SET NGAYBD = TO_DATE('01-09-2024', 'DD-MM-YYYY')
WHERE NAM = 2024 AND HK = 1;
...
UPDATE QLTDH.MOMON 
SET NGAYBD = TO_DATE('01-01-2025', 'DD-MM-YYYY') 
WHERE NAM = 2024 AND HK = 2;
...
UPDATE QLTDH.MOMON 
SET NGAYBD = TO_DATE('01-05-2025', 'DD-MM-YYYY') 
WHERE NAM = 2024 AND HK = 3;
